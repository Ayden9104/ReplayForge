...
Latest release: [v0.1.16](https://github.com/Ayden9104/ReplayForge/releases/tag/v0.1.16)
...
1. Grab `replayforge-0.1.16-linux-x86_64.tar.gz` from the [latest release](https://github.com/Ayden9104/ReplayForge/releases/tag/v0.1.16).
2. Extract and install:

```bash
tar -xzf replayforge-0.1.16-linux-x86_64.tar.gz
cd replayforge-0.1.16-linux-x86_64
./install.sh
```
...
```bash
./scripts/install-bin.sh ~/Downloads/replayforge-0.1.16-linux-x86_64.tar.gz
```
